...
coef_names   = {'beta','rho','sigmasq_v','omega','MHaccrate'};
...
subplot(3,1,1)
plot(1:nsave,rho_save(:,1)); hold on; yline(rho_true(1),'Linewidth',2,'Color',[.6 0 0]); hold on; yline(rho_mean_mix(1),'Linewidth',2);
ylabel('\rho_{1}, g=1');xlabel(['iter; true = ', num2str(rho_true(1)), ', est = ', num2str(rho_mean_mix(1))]);xlim([0 nsave]);
subplot(3,1,2)
plot(1:nsave,rho_save(:,2)); hold on; yline(rho_true(2),'Linewidth',2,'Color',[.6 0 0]); hold on; yline(rho_mean_mix(2),'Linewidth',2);
ylabel('\rho_{2}, g=2');xlabel(['iter; true = ', num2str(rho_true(2)), ', est = ', num2str(rho_mean_mix(2))]);xlim([0 nsave]);
subplot(3,1,3)
plot(1:nsave,rho_save(:,3)); hold on; yline(rho_true(3),'Linewidth',2,'Color',[.6 0 0]); hold on; yline(rho_mean_mix(3),'Linewidth',2);
ylabel('\rho_{3}, g=3');xlabel(['iter; true = ', num2str(rho_true(3)), ', est = ', num2str(rho_mean_mix(3))]);xlim([0 nsave]);
...
ylabel('\sigma^2_v_{1}, g=1');xlabel(['iter; true = ', num2str(sigmasq_true(1)), ', est = ', num2str(sigmav_mean_mix(1))]);xlim([0 nsave]);
subplot(3,1,2)
...
ylabel('\sigma^2_v_{2}, g=2');xlabel(['iter; true = ', num2str(sigmasq_true(2)), ', est = ', num2str(sigmav_mean_mix(2))]);xlim([0 nsave]);
subplot(3,1,3)
...
ylabel('\sigma^2_v_{3}, g=3');xlabel(['iter; true = ', num2str(sigmasq_true(3)), ', est = ', num2str(sigmav_mean_mix(3))]);xlim([0 nsave]);

F1{3,2} = figure('visible','off');
plot(1:nsave,sigmav_save(:,1)); 
hold on;
plot(1:nsave,sigmav_save(:,2)); 
hold on;
plot(1:nsave,sigmav_save(:,3)); 
...
saveas(F1{5,1},[result_subpath,'/','MH_acceptance_rate_of_rho'],'jpg')
